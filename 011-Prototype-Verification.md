...
6. **산출물** : 웹 데모, 플레이 로그, 개선 제안 등 프로토타입 결과물 목록.
7. **(추가) 파이썬 기반 데이터 생성** : 테스트용 대량 데이터를 자동 생성하는 스크립트 예시.
...
- [ ] **감정 기준 통과**: 통과 기준이 기능 완성이 아니라 목표 감정의 재현으로 정의되었는가? (Subnautica는 모듈러 잠수함 조종을 '지루함'으로 폐기하고, 침수 경보·수리를 '폭력 없는 긴장'으로 채택)
